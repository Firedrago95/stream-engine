...
export const SessionSummaryGrid: React.FC<SessionSummaryGridProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 my-8">
      <div className="p-5 bg-[#0c0d0f] border border-gray-800/80 rounded-2xl relative overflow-hidden flex flex-col justify-between group hover:border-[#00FFA3]/40 transition-all duration-300">
      ...
      <div className="p-5 bg-[#0c0d0f] border border-gray-800/80 rounded-2xl relative overflow-hidden flex flex-col justify-between group hover:border-[#67BFFF]/40 transition-all duration-300">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs text-gray-400 font-semibold tracking-wider flex items-center gap-1.5">
        ...
        <div>
          <div className="text-2xl sm:text-3xl font-black text-[#67BFFF] font-mono tracking-tight">
      ...
      <div className="p-5 bg-[#0c0d0f] border border-gray-800/80 rounded-2xl relative overflow-hidden flex flex-col justify-between group hover:border-[#A78BFA]/40 transition-all duration-300">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs text-gray-400 font-semibold tracking-wider flex items-center gap-1.5">
        ...
        <div>
          <div className="text-2xl sm:text-3xl font-black text-[#A78BFA] font-mono tracking-tight">
      ...
      <div className="p-5 bg-[#0c0d0f] border border-gray-800/80 rounded-2xl relative overflow-hidden flex flex-col justify-between group hover:border-[#00FFA3]/40 transition-all duration-300">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#00FFA3]/10 text-[#00FFA3] border border-[#00FFA3]/20">
