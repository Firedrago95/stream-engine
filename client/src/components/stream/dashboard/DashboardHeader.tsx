...
export const DashboardHeader: React.FC<{ onBack: () => void }> = ({ onBack }) => (
    <div className="py-4 sm:py-8 flex items-center gap-3">
      <button onClick={onBack} className="p-2 bg-[#1a1a1c] border border-gray-700 rounded-lg text-gray-100 hover:text-[#00FFA3] transition-colors">
