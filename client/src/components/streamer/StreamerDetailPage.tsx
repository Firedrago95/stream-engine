...
export const StreamerDetailPage: React.FC = () => {
  ...
  if (profileLoading || !profile) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4">
        ...
        <div className="text-gray-400 text-sm font-medium">스트리머 통계 데이터를 로딩 중입니다...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-16">
      <button
        onClick={() => navigate('/streamers')}
        className="inline-flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-[#00FFA3] transition-colors"
      >
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-gray-400 font-mono">
              <span>
                총 팔로워 <strong className="text-white">{header.currentFollowers.toLocaleString()}명</strong>
              </span>
              <span className="text-gray-600">|</span>
              <span className="flex items-center gap-1">
                최근 7일{' '}
                <strong className={header.followerGrowth7d >= 0 ? 'text-[#00FFA3]' : 'text-rose-400'}>
              ...
              <span className="flex items-center gap-1">
                최근 30일{' '}
                <strong className={header.followerGrowth30d >= 0 ? 'text-[#00FFA3]' : 'text-rose-400'}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
        <div className="p-4 sm:p-5 bg-[#141416] border border-[#2A2A2C] rounded-2xl">
          ...
          <p className="text-[10px] text-gray-500 mt-1">최근 30일 가중 평균</p>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-[#141416] border border-[#2A2A2C] rounded-2xl">
          ...
          <p className="text-[10px] text-gray-500 mt-1">최근 30일 순간 피크</p>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-[#141416] border border-[#2A2A2C] rounded-2xl">
          ...
          <p className="text-[10px] text-gray-500 mt-1">최근 30일 누적 라이브</p>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-[#141416] border border-[#2A2A2C] rounded-2xl">
          ...
          <p className="text-xl sm:text-2xl font-black text-white font-mono">
            {summary.hoursWatched.toLocaleString()}
            <span className="text-xs text-gray-400 font-normal ml-1">시간</span>
          </p>
          <p className="text-[10px] text-gray-500 mt-1">시청자 총 체류시간</p>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-[#141416] border border-[#2A2A2C] rounded-2xl col-span-2 lg:col-span-1">
          ...
          <p className="text-[10px] text-gray-500 mt-1">최근 30일간 성장</p>
        </div>
      </div>
